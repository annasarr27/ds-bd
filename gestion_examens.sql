...
CREATE TABLE `exams` (
  ...
  `fichier_corrige_type` varchar(255) DEFAULT NULL,
  PRIMARY KEY (`id`),
...
INSERT INTO `exams` VALUES (1,'Examen sur la virtualisation','Docker',1,'2025-03-20 02:55:28','uploads\\exams\\fichier_exam-1742439328366-994665355.pdf',NULL),(2,'Examen sur la cryptographie','question de cours',2,'2025-03-20 02:56:28','uploads\\exams\\fichier_exam-1742439388515-154013832.pdf','uploads\\corriges-type\\corrigeTypeFile-1742440146495-564728189.pdf');
...
INSERT INTO `submissions` VALUES (1,3,2,'uploads\\submissions\\fichier_submission-1742439770204-459022483.pdf','2025-03-20 03:02:50',NULL,NULL,NULL),(2,4,1,'uploads\\submissions\\fichier_submission-1742439856443-553630933.pdf','2025-03-20 03:04:16',NULL,NULL,NULL);
...
INSERT INTO `users` VALUES (1,'Babacar','Fall','babacarfall@esp.sn','baba@1234','enseignant','2025-03-20 02:46:53'),(2,'Doudou','FALL','doudoufall@esp.sn','sensei@980','enseignant','2025-03-20 02:47:13'),(3,'Cheikh Ahmed Tidiane','DIEND','cheikhahmedtidianedieng1@esp.sn','boufa@15','etudiant','2025-03-20 02:47:39'),(4,'Fatou','Ndour','fndour60@gmail.com','boucheikh@15','etudiant','2025-03-20 02:47:57');
...
-- Dump completed on 2025-03-20  7:58:40
